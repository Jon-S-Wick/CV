...
\usepackage[
  a4paper,
    ...
    bottom=2.5 cm, % seperation between body and page edge from the bottom
    left=2 cm, % seperation between body and page edge from the left
    right=2 cm, % seperation between body and page edge from the right
    % footskip=1.2 cm, % seperation between body and footer
...
\begin{document}
    ...
    \section{Summary}
        ...
        \begin{onecolentry}
          ...
          % I am pursuing a Bachelors in Science for molecular and cellular biology with a minor in computer science.
          % Currently I am researchering sRNA biogenesis and potential effector loci responsible for maintaining the genome integrity of \textit{Tetrahymena thermophila} in the Lee lab at WWU. I use computational biology to improve our understanding of sRNA's role in maintaining genome integrity through RNA interference in the model organisms \textit{Tetrahymena thermophila}.
          % Currently, I am using computational methods to advance the understanding of small RNAs in Tetrahymena thermophila which are responsible for maintaining genome integrity as a part of the Lee lab.
    ...
    \section{Education}
        ...
        \begin{onecolentry}
            \begin{highlights}
                \item GPA: 3.73/4.0 %(\href{https://example.com}{a link to somewhere})
    ...
    \begin{samepage}
      ...
      % \end{twocolentry}
      %   \begin{highlights}
      %   \item Organize events to provide information on new students.
      %   \item 
      %       \end{highlights}
